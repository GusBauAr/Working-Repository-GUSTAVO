...
export const callbacksComponent = (element) => {
    ...
    findHero(id, (heroHulk) => { // se va mandar el id como argumento
        element.innerHTML = heroHulk.name;
    }); 
...
const findHero = (id, callback) => {// se va recibi el id y el callback
    ...
    callback(hero); // se esta llamando el callback con el argumento de hero
